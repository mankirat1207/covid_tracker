...
$DEPARTMENT=$_POST['DnQ3'];

if ($conn->connect_error) {
 die("Connection failed: " . $conn->connect_error);
}
$query = "SELECT Student.Langara_ID AS LANGARA_ID, Student.Student_Name AS STUDENT_NAME
FROM Student, Student_In_Department, Department
WHERE (Student.Langara_ID=Student_In_Department.Langara_ID AND Student_In_Department.Department_ID=Department.Department_ID AND Department.Department_Name='$DEPARTMENT')";
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <h5 class="header col s12 light">Search reults:</h5>
    </div>
      <div class="row">';
