...
$ID=$_POST['SIDQ8A'];
$answer1 = $_POST['group81'];
$answer2 = $_POST['group82'];
...
if ($answer2 == "group82a") {
  ...
  elseif ($answer1 == "group81b") {
    $query="UPDATE Covid_19_Test
    SET Test_Status='Positive'
    WHERE Patient_ID IN (
    SELECT Patient_ID
    FROM Student_Recieves_Test AS t1, Student AS t2
    WHERE t1.Langara_ID= t2.Langara_ID AND t1.Langara_ID=$ID
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <h5 class="header col s12 light">Covid19 Test status has been updated</h5>
    </div>
      <div class="row">';
