...
if ($answer == "group2a") {
    $query = "SELECT LANGARA_ID, STUDENT_NAME AS SNAME FROM Student WHERE TRANSIT_USER=1";
}
else if ($answer == "group2b") {
    $query = "SELECT LANGARA_ID, EMPLOYEE_NAME AS SNAME FROM Employee WHERE TRANSIT_USER=1";
}
else if ($answer == "group2c"){
    $query = "(SELECT LANGARA_ID, STUDENT_NAME AS SNAME FROM Student WHERE TRANSIT_USER=1) UNION (SELECT LANGARA_ID, EMPLOYEE_NAME AS SNAME FROM Employee WHERE TRANSIT_USER=1)";
}
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <h5 class="header col s12 light">Search results:</h5>
    </div>
      <div class="row">';
